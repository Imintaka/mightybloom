...
export function MainNav() {
  ...
  return (
    <nav className="mx-auto w-full max-w-6xl px-4 py-3 sm:px-6 lg:px-8" aria-label="Основная навигация">
      <div className="relative">
        <div className="surface-card flex items-center justify-between gap-3 rounded-3xl border border-rose-200/70 px-3 py-2.5">
          ...
          >
            <span className="absolute inset-y-2 left-1/2 w-px -translate-x-1/2 rounded-full bg-rose-200/80" aria-hidden="true" />
            <span
